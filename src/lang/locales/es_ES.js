...
module.exports = {
  /* 01.General */
  'general.copyright': 'Widur © Todos los derechos reservados.',
  ...
  'menu.home': 'Inicio',
  'menu.app': 'Inicio',
  'menu.directory': 'Tableros',
  'menu.default': 'Defecto',
  'menu.callrecord': 'Analítica',
  'menu.userlist': 'Comercio electrónico',
  'menu.content': 'Contenido',
  'menu.advisor': 'Páginas',
  ...
  'menu.error': 'Error',
  'menu.coupons': 'Aplicaciones',
  'menu.promocode': 'Notas',
  ...
  'menu.lawyer': 'Pmf',
  'menu.sexologist': 'Base de Conocimientos',
  ...
  /* 04.Tableros */
  'directory.add-new-modal-title':'add User',
  'directory.pending-orders': 'Pedidos Pendientes',
  'directory.completed-orders': 'Pedidos Completados',
  'directory.refund-requests': 'Petición de Reembolso',
  'directory.new-comments': 'Nuevos Comentarios',
  'directory.sales': 'Ventas',
  'directory.orders': 'Pedidos',
  'directory.refunds': 'Reembolso',
  'directory.recent-orders': 'Pedidos Recientas',
  'directory.product-categories': 'Categorías de Producto',
  'directory.cakes': 'Tortas',
  'directory.tickets': 'Entradas',
  'directory.calendar': 'Calendario',
  'directory.best-sellers': 'Mejores Vendidos',
  'directory.website-visits': 'Visitas al sitio web',
  'directory.unique-visitors': 'Visitantes únicos',
  'directory.this-week': 'Esta Semana',
  'directory.last-week': 'La Semana Pasada',
  'directory.this-month': 'Este Mes',
  'directory.conversion-rates': 'Medidas de Conversión',
  'directory.per-session': 'Por Sección',
  'directory.profile-status': 'Estado del Perfil',
  'directory.payment-status': 'Estado del Pago',
  'directory.work-progress': 'Trabajo en Progreso',
  'directory.tasks-completed': 'Tareas Completadas',
  'directory.payments-done': 'Pagos Realizados',
  'directory.order-stock': 'Pedidos - Valores',
  'directory.categories': 'Categorías',
  'directory.quick-post': 'Publicación Rápida',
  'directory.title': 'Título',
  'directory.content': 'Contenido',
  'directory.category': 'Categoría',
  'directory.save-and-publish': 'Guardar y Publicar',
  'directory.top-viewed-posts': 'Publicaciones Más Vistas',
  'directory.posts': 'Puestos',
  'directory.pending-for-publish': 'Pendiente de Publicación',
  'directory.users': 'Usuarios',
  'directory.on-approval-process': 'En Proceso de Aprobación',
  'directory.alerts': 'Alertas',
  'directory.waiting-for-notice': 'Esperando Aviso',
  'directory.files': 'Archivos',
  'directory.pending-for-print': 'Pendiente para imprimir',
  'directory.logs': 'Troncos',
  'directory.widur': 'Widur',
  'directory.magic-is-in-the-details': 'LA MAGIA ESTA EN LOS DETALLES',
  'directory.yes-it-is-indeed': '¡Si es verdad!',
  'directory.advanced-search': 'Búsqueda Avanzada',
  'directory.toppings': 'Coberturas',
  'directory.type': 'Categoría',
  'directory.keyword': 'Palabra Clave',
  'directory.search': 'Búsqueda',
  'directory.top-rated-items': 'Artículos Mejores Valorados',
  'directory.user-mobile': 'User Mobile',

  /* 05.Esquemas */
  'advisor.add-new': 'AGREGAR NUEVO',
  'advisor.add-new-modal-title': 'Agregar ítem nuevo',
  'advisor.display-options': 'Opciones de Pantalla',
  'advisor.orderby': 'Ordenar por : ',
  'advisor.total': 'Total: ',
  'advisor.viewing': 'Viewing : ',
  'advisor.product-name': 'Nombre del Producto',
  'advisor.category': 'Categoría',
  'advisor.description': 'Descripción',
  'advisor.status': 'Estado',
  'advisor.cancel': 'Cancelar',
  'advisor.submit': 'Enviar',
  'advisor.delete': 'Borrar',
  'advisor.another-action': 'Otra accion',
  'advisor.actions': 'ACCIONES',
  'advisor.header': 'Encabezado',
  'advisor.details': 'DETALLES',
  'advisor.orders': 'PEDIDOS',
  'advisor.rating': 'Clasificación',
  'advisor.price': 'Precio',
  'advisor.ingredients': 'Ingredients',
  'advisor.is-vegan': 'Es Vegano',
  'advisor.order-status': 'Estado del Pedido',
  'advisor.bake-progress': 'Progreso de Hornear',
  'advisor.popularity': 'Popularidad',
  'advisor.comments': 'Comentarios',
  'advisor.error-title': 'Vaya, parece que ha ocurrido un error!',
  'advisor.error-code': 'Código de error',
  'advisor.go-back-home': 'REGRESAR A INICIO',
  ...
  'advisor.react-version': 'React Versión',
  'advisor.inline-version': 'Estilo en Linea Html Versión',
  'advisor.like': 'Me gusta',
  'advisor.likes': 'Me gusta',
  'advisor.details-title': 'Detalles',
  'advisor.comments-title': 'Comentarios',
  'advisor.questions-title': 'Preguntas',
  'advisor.similar-projects': 'Proyectos Similares',
  'advisor.send': 'Enviar',
  'advisor.addComment': 'Añadir un comentario',
  'advisor.location': 'Ubicación',
  'advisor.responsibilities': 'Responsabilidades',
  'advisor.photos': 'Fotos',
  'advisor.who-to-follow': 'A quién seguir',
  'advisor.follow': 'SEGUIR',
  'advisor.followers': 'SEGUIDORES',
  'advisor.recent-posts': 'Mensajes Recientes',
  'advisor.profile': 'PERFIL',
  'advisor.friends': 'AMIGOS',
  'advisor.images': 'IMAGENES',
  'advisor.purchase': 'COMPRA',
  'advisor.price.developer': 'REVELADOR',
  'advisor.price.team': 'EQUIPO',
  'advisor.price.enterprise': 'EMPRESA',
  'advisor.price.twofactorauthentication': 'Autenticación de dos factores',
  'advisor.price.teampermissions': 'Permisos del equipo',
  'advisor.price.245Support': '24/5 Soporte',
  'advisor.price.247Support': '24/7 Soporte',
  'advisor.price.useractionsauditlog': 'Registro de acciones del usuario',
  'advisor.prices.featurecomparison': 'Comparación de Características',
  'advisor.prices.pricecomparison': 'Comparación de Precios',
  ...
  /* 06.03.Notas */
  'promocode.add-new': 'AGREGAR NUEVO',
  'promocode.add-new-title': 'Añadir Nuevo',
  'promocode.title': 'Título',
  'promocode.detail': 'Detalle',
  'promocode.category': 'Categoría',
  'promocode.label': 'Etiqueta',
  'promocode.status': 'Estado',
  'promocode.cancel': 'Cancelar',
  'promocode.submit': 'Enviar',
  'promocode.action': 'Accion',
  'promocode.another-action': 'Otra accion',
  'promocode.display-options': 'Opciones de Pantalla',
  'promocode.orderby': 'Ordenar por : ',
  'promocode.all-tasks': 'Todas las Tareas',
  'promocode.pending-tasks': 'Tareas Pendientes',
  'promocode.completed-tasks': 'Tareas Completadas',
  'promocode.categories': 'Categorías',
  'promocode.labels': 'Etiquetas',
